%% Notes / To Do
    % New - replicates + plot replicates. 
...
% Lande line of equilibria 
plot(0:0.1:1, ((sigF^2)./(sigM^2) + 1)*((0:0.1:1) - optM*((sigF^2)./(sigM^2))), 'Color','black')
sgtitle(["t= " + tMax + ";" + " n= " + n + ";" + " rng= " + "  Bins= "+ nBins + ";" + rng().Seed + ";" +  " mutT= " + mutRtT + "+" + mutAsymT + ";" + " mutP= " + mutRtP + "+" + mutAsymT,...
    "nTrL= " + nLoci + ";" + " + nPrL= " + nLociP + ";" + " optM= " + optM + ";" + " Male \sigma= "+ sigM + ";" + " Female \sigma= " + sigF])
